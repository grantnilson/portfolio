...
export default function FirstExperienceCard({ experience }: Props) {
  ...
  return (
    <article className="flex flex-col h-flex overflow-y-scroll rounded-lg items-center space-y-7 flex-shrink-0 w-[300px] md:w-[400px] xl:w-[500px] snap-center bg-[#292929] p-10 hover:opacity-100 opacity-40">
