...
export default function FirstExperienceCard({ experience }: Props) {
  ...
  return (
    <article className="flex flex-col min-h-screen overflow-y-scroll rounded-lg items-center space-y-7 flex-shrink-0 w-[500px] md:w-[600px] xl:w-[900px] snap-center bg-[#292929] p-10 hover:opacity-100 opacity-40">
