...
function WorkExperience({ experience }: Props) {
  return (
    <div>
      ...
      >
        <div className="w-full top-24 flex space-x-5 overflow-x-scroll p-10 snap-x snap-mandatory scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#F7AB0A]/80"></div>
      </motion.div>
    </div>
  );
}
